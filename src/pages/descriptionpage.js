        ...
        <div className="w-100 h-100-vh bg-white ">
            ...
            <div className="w-100 border-1-solid d-flex flex-column">
                ...
                <div className="w-70 text-center position-relative m-auto">
                    <img src="http://localhost:8080/image/inquery-main.png" className="w-100 h-500-px mt-3" />
                ...
                <div className="w-100 d-flex flex-column">
                    ...
                    <div className=" d-flex flex-column mt-5 mb-6 position-relative px-5 pt-5 mx-auto">
                        ...
                        <img src="http://localhost:8080/image/addpackage-success-main.png" className="w-400-px h-200-px mt-5" />
                ...
                <div className="w-100 d-flex flex-column mt-3">
                    <div className="d-flex flex-column px-3">
                        ...
                        <span className="f-18-px"> 6/ ສາມາດກົດປຸ່ມ download ເພື່ອດາວໂຫຼດຟາຍທີ່ອັບເດດ  </span>

                    </div>
                    <div className="w-70 m-auto position-relative pt-5">
                        <img src="http://localhost:8080/image/modifylistphone-main.png" className="w-100  h-500-px" />
                    ...
                    <div className="w-100 my-3 d-flex flex-column position-relative px-5 ">
                        ...
                        <div className="w-100  position-relative d-flex justify-content-center">
                            ...
                            <div className="d-flex flex-column align-items-center border-grey">
                                <img src="http://localhost:8080/image/file-txt-modify-main.png" className="w-355-px h-220-px" />
                                <span className="f-16-px">  ປະເພດຟາຍ file txt </span>
                            </div>

                            <div className="d-flex flex-column align-items-center border-grey ml-7">
                                <img src="http://localhost:8080/image/file-xlsx-modify-main.png" className="w-355-px h-220-px" />
                    ...
                    <div className="w-100 my-3 d-flex position-relative px-5 justify-content-center">
                        <div className="d-flex flex-column align-items-center">
                            <img src="http://localhost:8080/image/dialog-typefile-main.png" className="w-355-px h-220-px" />
                            <span className="f-16-px">  ກະລຸນາເລືອກຟາຍໃຫ້ຖືກປະເພດ </span>
                        </div>

                        <div className="d-flex flex-column align-items-center ml-5 ">
                            <img src="http://localhost:8080/image/file-notfound-data-main.png" className="w-355-px h-220-px" />
                ...
                <div className="w-100 d-flex flex-column">
                    <div className="px-3 d-flex flex-column">
                        ...
                        <span className="f-18-px"> 1/ ປ້ອນຂໍ້ມູນ ເບີໂທ , ເລືອກ package , ເລືອກວັນທີ່ເລີ່ມຕົ້ນ , ເລືອກວັນທີ່ໝົດອາຍຸ , ເລືອກມື້ RefillStopTime ຖ້າປ້ອນຂໍ້ມູນຄົບ ໃຫ້ກັົດປຸ່ມ add package </span>

                        <span className="f-18-px"> 2/ ກົດປຸ່ມ add package ເພື່ອຕື່ມ pagekage ເບີທີ່ປ້ອນ ຖ້າສຳເລັດຈະມີ ຟາຍ download xlsx ກະລຸນາປ້ອນຟາຍເພື່ອກວດເບິ່ງ ການຕື່ມ pagekage  </span>
                    ...
                    <div className="w-70 m-auto position-relative pt-5">
                        ...
                        <img src="http://localhost:8080/image/addpackagephone-main.png" className="w-100 h-500-px" />
                ...
                <div className="w-100 d-flex flex-column mt-5">
                    ...
                    <div className="w-70 position-relative m-auto pt-5">
                        ...
                        <img src="http://localhost:8080/image/addpackagelistphone-main.png" className="w-100 h-500-px" />
                    ...
                    <div className="w-100 py-3 d-flex justify-content-center mt-5 mb-3">
                        ...
                        <div className=" d-flex flex-column w-355-px h-200-px  align-items-center">
                            <img src="http://localhost:8080/image/add-notfoundfile-main.png" className="h-300-px w-100" />
                            <span>  ຟາຍທີ່ທ່ານເລືອກບໍ່ມີຂໍ້ມູນ  </span>
                        </div>
                        <div className=" d-flex flex-column w-355-px h-200-px align-items-center ml-5">
                            <img src="http://localhost:8080/image/addpackage-success-main.png" className="h-300-px w-100" />
                ...
                <div className="w-100  d-flex flex-column px-5">
                    ...
                    <div className="w-100 d-flex pt-4 mt-2 pb-3">
                        ...
                        <div className="d-flex flex-column">
                            <img src="http://localhost:8080/image/inquery-timeout-main.png" className="w-355-px h-200-px m-auto  pb-1" />
