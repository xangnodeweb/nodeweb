            ...
            <div className="w-100 border-1- d-flex flex-column">
                ...
                <div className="w-100 d-flex flex-column mt-3">
                    ...
                    <div className="w-100 my-3 d-flex position-relative px-5 justify-content-center">
                        ...
                        <div className="d-flex flex-column align-items-center ml-5 ">
                            <img src="http://127.0.0.1:8080/image/modify-success.main.png" className="w-355-px h-220-px" />
                ...
                <div className="d-flex flex-column mt-5 px-3">
                    ...
                    <div className="position-relative w-70 mx-auto mt-2 ">
                        <img src="http://127.0.0.1:8080/image/changemain-max-setvalidity-main.png" className="w-100 h-500-px" />
                    ...
                    <div className="position-relative d-flex justify-content-center mt-1">
                        <div className="d-flex position-relative flex-column align-items-center mt-6 w-50">
                            ...
                            <img src="http://127.0.0.1:8080/image/file-changemainoffering-main.png" className="h-300-px w-100 border-grey" />
                    ...
                    <div className="d-flex justify-content-around mt-3">
                        ...
                        <div className="d-flex flex-column align-items-center">
                            <img src="http://127.0.0.1:8080/image/dialog-inquery-success-main.png" className="max-w-450-px h-300-px" />
                            <span className="f-18-px mt-1">  ອັບເດດຂໍ້ມູນ changemainoffering </span>
                        </div>

                        <div className="d-flex flex-column align-items-center">
                            <img src="http://127.0.0.1:8080/image/dialog-changemaxday-success-main.png" className="max-w-450-px h-300-px " />
                            <span className="f-18-px mt-1"> ອັບເດດຂໍ້ມູນ changemaxday success  </span>
                        </div>
                        <div className="d-flex flex-column align-items-center">
                            <img src="http://127.0.0.1:8080/image/dialog-setvalidity-success-main.png" className="max-w-450-px h-300-px " />
                    ...
                    <div className="p-5 d-flex justify-content-around mt-4">
                        ...
                        <div className="position-relative d-flex flex-column align-items-center">
                            <img src="http://127.0.0.1:8080/image/setvaliditydate-main.png" className="h-300-px " />
                ...
                <div className="d-flex flex-column px-3">
                    ...
                    <div className="d-flex flex-column">
                        ...
                        <div className="w-70 m-auto pt-3 position-relative  ">
                            ...
                            <img src="http://127.0.0.1:8080/image/desclogpage-main.png" className="h-500-px w-100" />
